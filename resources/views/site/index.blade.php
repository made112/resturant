  ...
  <div class="hero_area">
          ...
          <div class="" id="">
            ...
            <div class="custom_menu-btn">
              <button onclick="openNav()">
                <img src="{{asset('assets/site/images/menu.png')}}" alt="">
              </button>
            </div>
            <div id="myNav" class="overlay">
              <div class="overlay-content">
                ...
                <a href="testimonial.blade.php">Testimonial</a>
              </div>
            </div>
          </div>
        </nav>
    ...
    <section class="slider_section ">
      ...
      <div class="slider_container">
        <div class="item">
          <div class="img-box">
            <img src="{{asset('assets/site/images/slider-img1.png')}}" alt="" />
          </div>
        </div>
        <div class="item">
          <div class="img-box">
            <img src="{{asset('assets/site/images/slider-img2.png')}}" alt="" />
          </div>
        </div>
        <div class="item">
          <div class="img-box">
            <img src="{{asset('assets/site/images/slider-img3.png')}}" alt="" />
          </div>
        </div>
        <div class="item">
          <div class="img-box">
            <img src="{{asset('assets/site/images/slider-img4.png')}}" alt="" />
          </div>
        </div>
        <div class="item">
          <div class="img-box">
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('assets/site/images/r1.jpg')}}" class="box-img" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Breakfast
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('assets/site/images/r2.jpg')}}" class="box-img" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Lunch
        ...
        <div class="col-sm-6 col-md-4 mx-auto">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('assets/site/images/r3.jpg')}}" class="box-img" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Dinner
      ...
      <div class="col-md-9 mx-auto">
        <div class="row">
          <div class="col-md-7 col-lg-8">
            <div class="detail-box">
              ...
              <div class="app_btn_box">
                <a href="" class="mr-1">
                  <img src="{{asset('assets/site/images/google_play.png')}}" class="box-img" alt="">
                </a>
                <a href="">
                  <img src="{{asset('assets/site/images/app_store.png')}}" class="box-img" alt="">
                </a>
              </div>
          ...
          <div class="col-md-5 col-lg-4">
            <div class="img-box">
              <img src="{{asset('assets/site/images/mobile.png')}}" class="box-img" alt="">
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-11 col-lg-10 mx-auto">
        ...
        <div class="box">
          <div class="col-md-7 mx-auto">
            <div class="img-box">
              <img src="{{asset('assets/site/images/about-img.jpg')}}" class="box-img" alt="">
            </div>
          </div>
          <div class="detail-box">
            <p>
    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('assets/site/images/n1.jpg')}}" class="box-img" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Tasty Food For you
        ...
        <div class="col-md-6">
          <div class="box">
            <div class="img-box">
              <img src="{{asset('assets/site/images/n2.jpg')}}" class="box-img" alt="">
            </div>
            <div class="detail-box">
              <h4>
                Breakfast For you
      ...
      <div class="container">
        ...
        <div class="info_links">
          <ul>
            ...
            <li>
              <a class="" href="blog.blade.php">
                Blog
              </a>
            </li>
            <li>
              <a class="" href="testimonial.blade.php">
                Testimonial
              </a>
            </li>
          </ul>
