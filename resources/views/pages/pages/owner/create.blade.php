...
{{--                                </div>--}}
                ...
                <div class="col-xl-9 col-lg-8">
                    <div class="card">
                        <div class="card-header d-flex justify-content-between">
                            <div class="header-title">
                                <h4 class="card-title">New Owner Information</h4>
                            </div>
                        </div>
                        <div class="card-body">
                            <div class="new-Owner-info">
                                    <div class="row">
                                        ...
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="add1">Country</label>
                                            <input name = "country" type="text" class="form-control" id="add1" placeholder="Street Address 1">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="add2">City</label>
                                            <input name = "city" type="text" class="form-control" id="add2" placeholder="Street Address 2">
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label class="form-label" for="cname">Address</label>
                                            <input name = "address" type="text" class="form-control" id="cname" placeholder="Company Name">
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label class="form-label" for="mobno">Mobile Number:</label>
                                            <input name = "phone" type="text" class="form-control" id="mobno" placeholder="Mobile Number">
                                        </div>
                                    ...
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label class="form-label" for="uname">Owner Name:</label>
                                            <input name = "username" type="text" class="form-control" id="uname" placeholder="Owner Name">
                                        </div>
                                        <div class="form-group col-md-6">
                                        ...
                                        <div class="form-group col-md-6">
                                            ...
                                            <input name = "confirm_password"  type="password" class="form-control" id="rpass" placeholder="Repeat Password ">
                                        </div>
                                    </div>
                                    <div class="checkbox">
